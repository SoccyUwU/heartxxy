...
abstract class PregxxyModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<PregxxyModDependenciesExtension>("pregxxyModDependencies")
