...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/pregxxy.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: pregxxy-common-common-refmap.json
        // fixed:   pregxxy-common.refmap.json
